...
ROUTING_KEY_STATUS_CREATED = os.getenv("ROUTING_KEY_STATUS", "request.status.created")
ROUTING_KEY_STATUS_VALIDATED = os.getenv("ROUTING_KEY_STATUS", "request.status.validated")
ROUTING_KEY_STATUS_REJECTED = os.getenv("ROUTING_KEY_STATUS", "request.status.rejected")
